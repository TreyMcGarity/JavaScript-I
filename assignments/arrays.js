...
console.log("The last car is a " + lastCar);
...
carModels = carModelsSorted.sort();
...
console.log("The car's years are: \n" + carYears);
...
console.log("number of cars older than 2000 is: " + oldCars.length);
...
console.log("Your results are:" + JSON.stringify(BMWAndAudi, null, '\t'));
